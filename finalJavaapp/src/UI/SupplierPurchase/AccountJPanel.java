...
public class AccountJPanel extends javax.swing.JPanel {
     ...
     */
    public AccountJPanel(JPanel userProcessContainer, UserAccount account, SupplierEnterprise enterprise) {
        initComponents();
    ...
    public void populateProfitTable() {
        ...
        for (Material material : enterprise.getSoldMaterialDirectory().getMaterialList()) {
            if(material.getQuantity()!=0) {
                ...
                row[3] = material.getQuantity()*material.getPrice();
            
                model.addRow(row);
                totalProfit += material.getQuantity()*material.getPrice();
            }
        }
    ...
    private void initComponents() {
        ...
        add(totalProfitJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 320, 76, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 370, -1, -1));

        enterpriseLabel.setFont(new java.awt.Font("Felix Titling", 1, 18)); // NOI18N
        enterpriseLabel.setText("Department :");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 160, 30));

        valueLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        valueLabel.setText("<value>");
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 47, 160, 20));

        enterpriseLabel1.setFont(new java.awt.Font("Felix Titling", 1, 18)); // NOI18N
        enterpriseLabel1.setText("Company Account");
        add(enterpriseLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 80, 210, 30));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, -1, 180));
        ...
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(-50, -70, 910, 680));

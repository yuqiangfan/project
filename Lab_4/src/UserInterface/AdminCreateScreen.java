...
public class AdminCreateScreen extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(username == null || username.equals("")) {
            ...
            JOptionPane.showMessageDialog(panelRight, "Username can't be empty!");
            return;
        }
        ...
        if(!usernamePatternCorrect()) {
            txtUser.setBorder(BorderFactory.createLineBorder(Color.red));
            jLabel1.setForeground(Color.red);
            JOptionPane.showMessageDialog(panelRight, "Username should be the form of xxx_xxx@xxx.xxx");
            return;
        }
        ...
        if(!passwordPatternCorrect()) {
            ...
            JOptionPane.showMessageDialog(panelRight, "Password should be at least 6 digits and a combination of number, upper case, lower case and special charactors $, *, # or &");
            return;
        }
        ...
        if(!p1.equals(p2)) {
            ...
            JOptionPane.showMessageDialog(panelRight, "Passwords don't match!");
            return;
        }
